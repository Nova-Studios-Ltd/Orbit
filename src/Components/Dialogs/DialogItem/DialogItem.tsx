...
export interface DialogItemProps extends NCComponent { // TODO: Customize props as appropriate
  children?: ReactNode,
...
function DialogItem(props: DialogItemProps) {
  ...
  const classNames = useClassNames("DialogItemContainer", props.className);
