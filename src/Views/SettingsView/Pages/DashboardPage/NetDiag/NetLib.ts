...
export function LatencyVisual(latency: number, mappings: number[]) : [string, IndicatorState] {
  ...
  if (latency <= mappings[1]) return [`${latency}ms`, IndicatorState.Intermedate];
